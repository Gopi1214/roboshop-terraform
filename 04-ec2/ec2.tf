...
module "shipping" {
  ...
  tags = merge(
         ...
         {
           Name = "${local.ec2_name}-shipping-g"
         }
  )
}
...
module "catalogue" {
  ...
  tags = merge(
         ...
         {
           Name = "${local.ec2_name}-catalogue-g"
         }
  )
}
